...
class HelpCommandCog(discord.Cog):
    ...
    async def guide(self, ctx: Context) -> None:
        ...
        embed.add_field(
            ...
            value='Αν ο χρήστης **δεν ανήκει** σε κάποια ομάδα:\n'
                  ...
                  'χρήστη που την έστειλε. Παράλληλα, δημιουργεί ένα καινούργιο ιδιωτικό κανάλι, κάτω από την κατηγορία καναλιών '
                  '**Teams**, για τα μέλη της ομάδας, όπως και έναν ξεχωριστό ρόλο με το όνομα της ομάδας\n'
        ...
        await ctx.respond(embed=embed) #for now responding
